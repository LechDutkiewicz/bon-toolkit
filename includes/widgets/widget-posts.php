...
class Bon_Toolkit_Widget_Posts extends WP_Widget {
	...
	function widget( $sidebar, $instance ) {
		...
		<?php elseif ( $args['post_type'] === 'promotions' ) : ?>

			<?php $query_args['tax_query'] = $tax_query; ?>
			<?php $post_query = new WP_Query( $query_args ); ?>
			...
			if ( $post_query->have_posts() ) :
				...
				echo '<!--Posts widget - ' . __( 'No post found.', 'bon-toolkit' ) . '-->';
			endif;
			wp_reset_query();
			?>
