...
if( !function_exists('bon_toolkit_setup_quiz_post_type') ) {
	...
	function bon_toolkit_setup_quiz_post_type() {
		...
		$cpt->create('Quiz', array( 'menu_icon' => 'dashicons-clipboard', 'exclude_from_search' => true, 'show_in_nav_menus' => false, 'supports' => array('editor', 'title', 'thumbnail'), 'menu_position' => 50 ), array(), $name, $plural );
