...
if( !function_exists('bon_toolkit_setup_poll_post_type') ) {
	...
	function bon_toolkit_setup_poll_post_type() {
		...
		$cpt->create('Poll', array( 'menu_icon' => 'dashicons-list-view', 'show_in_nav_menus' => false, 'exclude_from_search' => true, 'supports' => array('editor', 'title', 'thumbnail'), 'menu_position' => 50 ), array(), $name, $plural );
