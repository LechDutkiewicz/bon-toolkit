...
if( !function_exists('bon_toolkit_setup_slider_post_type') ) {
	...
	function bon_toolkit_setup_slider_post_type() {
		...
		$cpt->create('Slider', array( 'menu_icon' => 'dashicons-slides', 'show_in_nav_menus' => false, 'exclude_from_search' => true, 'supports' => array('editor','title', 'page-attributes', 'thumbnail'), 'public' => false, 'menu_position' => 20 ), array(), $name, $plural );
		...
		$meta_fields = array(
			...
			array(
				'label'	=> __('New and returning users'),
				'id'	=> $prefix.'slider_returning', 
				'type'	=> 'select',
				'options' => array(
					'1' => __('Only new visitors', 'bon-toolkit'),
					'2' => __('Both new and returning visitors'),
					'3'	=> __('Only returning visitors')
				),
				'desc'	=> __('Pick who will be this picture displayed to', 'bon-toolkit')					
			),
