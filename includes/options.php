...
$options[] = array(
	'type' => 'multicheck',
	'id' => 'disabled_locations_of_share_button',
	'desc' => __('Disable the social share button on posts and pages','bon-toolkit'),
	'label' => __('Disable Social Share button', 'bon-toolkit'),
